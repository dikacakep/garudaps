...
export default function About() {
  ...
  return (
    <section id="about" className="relative py-24 md:py-40 overflow-hidden bg-[#0a0a0a]">
      
      {/* Connector Gradients */}
      <div className="absolute top-0 left-0 w-full h-32 md:h-64 bg-linear-to-b from-black via-[#0a0a0a] to-transparent z-10 pointer-events-none" />
      <div className="absolute bottom-0 left-0 w-full h-32 md:h-64 bg-linear-to-t from-black via-[#0a0a0a] to-transparent z-10 pointer-events-none" />
      ...
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-40 h-40 md:w-200 md:h-150 bg-orange-600/10 blur-3xl md:blur-[100px] rounded-full pointer-events-none z-0 transform-gpu" />
      ...
      <div className="w-full max-w-7xl px-4 mx-auto relative z-20">
        ...
        >
          <div className="hidden md:block absolute -inset-px bg-linear-to-r from-orange-500/0 via-orange-500/20 to-purple-500/0 rounded-4xl blur-md opacity-30 group-hover:opacity-60 transition duration-1000" />

          {/* Main Card Container */}
          <div className="relative bg-linear-to-br from-white/5 via-[#0a0a0a] to-black backdrop-blur-md border border-white/5 rounded-[30px] overflow-hidden shadow-2xl">
            ...
            <div className="absolute bottom-0 right-0 p-6 opacity-30 pointer-events-none">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-0 items-center">
              ...
              <div className="p-8 md:p-16 flex flex-col justify-center relative z-10">
                ...
                {/* Narrative */}
                <div className="space-y-6 text-base md:text-lg text-white/80 leading-relaxed font-light text-justify">
                  <p>
                ...
                {/* Footer Tech Stats  */}
                <div className="mt-10 pt-6 border-t border-white/5 flex flex-wrap items-center justify-between gap-3">
                   
                   <div className="px-4 py-2 rounded-lg bg-white/2 border border-white/5 flex flex-col items-center flex-1 min-w-20">
                   ...
                   <div className="px-4 py-2 rounded-lg bg-white/2 border border-white/5 flex flex-col items-center flex-1 min-w-20">
                      ...
                      <span className="font-mono font-bold text-lg text-green-400 drop-shadow-[0_0_8px_rgba(74,222,128,0.5)]">
                        ONLINE
                      </span>
                   </div>
                </div>
              ...
              {/* --- RIGHT: IMAGE --- */}
              <div className="relative h-64 md:h-112.5 lg:h-full min-h-75 md:min-h-125 w-full overflow-hidden group/image">
                ...
                <div className="absolute inset-0 bg-linear-to-r from-[#0a0a0a] via-transparent to-transparent opacity-80" />
                <div className="absolute inset-0 bg-linear-to-t from-[#0a0a0a] via-transparent to-transparent opacity-80" />

                {/* --- LOGO HOLOGRAM --- */}
                <div className="absolute top-6 right-6 z-30 pointer-events-none">
                   <div className="relative w-16 h-16 md:w-24 md:h-24 hover:scale-110 transition-transform duration-500">
                      <div className="hidden md:block absolute inset-0 bg-orange-500 blur-[30px] opacity-50 animate-pulse"></div>
                      <Image 
